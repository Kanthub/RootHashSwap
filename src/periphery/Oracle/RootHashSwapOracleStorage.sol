...
contract RootHashSwapOracleStorage {
    ...
    error RootHashSwapOracle_InvalidPair();
    error RootHashSwapOracle_InsufficientElapsedTime();
    error RootHashSwapOracle_InvalidToken();
}
